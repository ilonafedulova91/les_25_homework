...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        books = Category.objects.create(
            name="Книги", description="Печатные и цифровые книги"
        )

        clothes = Category.objects.create(
            name="Одежда", description="Различные виды одежды"
        )
        ...
        self.stdout.write(self.style.SUCCESS("Новые продукты успешно добавлены"))
